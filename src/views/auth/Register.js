                  ...
                  <div className="mt-10 py-10 border-t border-blueGray-200 text-center">
                    <div className="flex flex-wrap justify-center">
                      <div className="w-full lg:w-9/12 px-4">
                        ...
                        You have 12 hours to activate your account. It can take up to 15 min
                        to receive our email.
                        </p>
                        <button onClick={onResendEmail} className="button font-normal text-lightBlue-500">
                ...
                <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-200 border-0">
                  ...
                  <div className="mt-10 py-10 border-t border-blueGray-200 text-center">
                    ...
                    registration :
                        ...
                        <button onClick={onReset} className="button font-normal text-lightBlue-500">
